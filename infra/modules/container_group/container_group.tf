...
resource "azurerm_container_group" "example" {
  ...
  identity {
    type         = "UserAssigned"
    identity_ids = "/subscriptions/${azure_subscription_id[0]}/resourceGroups/slack-bot-rg/providers/Microsoft.ManagedIdentity/userAssignedIdentities/slackbot-identity"
  }
